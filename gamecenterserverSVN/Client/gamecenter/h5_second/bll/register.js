...
(function (REGISTER) {
    ...
    function sendCode() {
        ...
        GAMECENTER.gsUserLoginSendCode({ phone: phone_number.val(), isreg: true }, function (resp) {
            if (resp.data) {
                var dat = resp.data;
                key = dat.key;
            }
    ...
    REGISTER.onRandNick = onRandNick;

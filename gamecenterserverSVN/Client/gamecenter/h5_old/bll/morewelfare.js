...
(function (MOREWELFARE) {
    ...
    MOREWELFARE.loadDefaultData = loadDefaultData;
    ...
    MOREWELFARE.loadWelfareGift = loadWelfareGift;
    function loadWelfare(list) {
        var today = new Date();
    ...
    MOREWELFARE.loadWelfare = loadWelfare;
    ...
    MOREWELFARE.getGiftCode = getGiftCode;
    function showMask() {
        $(".mask").css("display", "block");
    }
    MOREWELFARE.showMask = showMask;
    function hideMask() {
        $(".mask").css("display", "none");
    }
    MOREWELFARE.hideMask = hideMask;
})(MOREWELFARE || (MOREWELFARE = {}));
//# sourceMappingURL=morewelfare.js.map
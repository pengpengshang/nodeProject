...
function modifyNickname(){
	var html ='<div class="modifyNickname martop36">';
		html +='<div class="borpad"><i></i><input type="text" placeholder="请输入新昵称" id="nickname" value='+GAMECENTER.userinfo.nickname+'></div>';
		html += '<a href="javascript:;" class="PI_btn" onclick="MODIFYMESS_NEW.updateNickName()">完成</a>';
		html +='</div>';
	return html;
}
...
function modifyPwdY(){
	...
	html += '<div class="modifyPwdY_code borpad"><i></i><input type="text" placeholder="请输入验证码" id="phoneCode"/><a href="javascript:" id="sendCode" onclick="MODIFYMESS_NEW.getCode()">发送验证码</a></div>';
	...
	html += '<a href="javascript:;" class="PI_btn" onclick="MODIFYMESS_NEW.fgModifyPwd()">确定</a>';
		html +='</div>';
	return html;
}
...
function modifyPhone(){
	var html ='<div class="modifyPhone martop36">';
		...
		html += '<div class="modifyphone_code borpad"><i></i><input type="text" placeholder="请输入验证码" id="phoneCode"/><a href="javascript:" id="sendCode" onclick="MODIFYMESS_NEW.sendCode()">发送验证码</a></div>';
		html +='<div class="tipsWorld">您将会收到一条短信，短信中会告知验证码。验证过程中不收取任何费用。</div>';
		html += '<a href="javascript:;" class="PI_btn" onclick="MODIFYMESS_NEW.cognatePhone()">确认绑定</a>';
		html +='</div>';
	return html;
}
...
function modifymail(){
	...
	html += '<div class="modifymail_code borpad"><i></i><input type="text" placeholder="请输入验证码" id="mailCode"/><a href="javascript:" id="sendMailCode" onclick="MODIFYMESS_NEW.sendMailCode()">发送验证码</a></div>';
		html +='<div class="tipsWorld">我们会发送邮件至您的邮箱，请注意查收验证码</div>';
		html += '<a href="javascript:;" class="PI_btn" onclick="MODIFYMESS_NEW.cognateMail()">确认绑定</a>';
		html +='</div>';
	return html;
}
...
function mailBind(){
	var html ='<div class="mailBind">';
		...
		html +='<a href="modifyMess.html#/modifymail" class="PI_btn">更改邮箱</a>';
		html +='</div>';
	return html;
}
...
function phoneBind(){
	var html ='<div class="phoneBind">';
		...
		html +='<a href="modifyMess.html#/modifyPhone" class="PI_btn">更改手机</a>';
		html +='</div>';
	return html;
}

...
function phoneLogin(){
	...
	html +='<a href="javascript:;" id="sendCode" style=" color: white;border: 1px solid rgb(104,139,181);padding:4px;background-color: rgb(104,139,181);float: right;" onclick="LOGININDEX_NEW.sendCode(true);">获取验证码</a></div>'
	html += '<div class="login_mode2" style="position: relative;top:2.2rem;width:100%;text-align: center;" >'
	html +='<img src="../style/img/login/login.png" style="margin:auto;width: 1.8rem;" class="phonebtn" id="Wbtn" onclick="LOGININDEX_NEW.fgPhonelogin();">'

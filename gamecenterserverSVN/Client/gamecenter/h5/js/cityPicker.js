var provinces = {
    ...
    "X": {
        ...
        "香港": ["湾仔区","九龙五区","九龙城区","深水埗区","油尖旺区","黄大仙区","观塘区","新界东四区","西贡区","沙田区","大埔区","新界西五区","离岛区","葵青区","荃湾区","屯门区","元朗区"]
    },
    "Y": {
    ...
    p.cityClick = function () {
        ...
        $(".city-picker").on("click", function (e) {
            ...
            if ($(target).is("li")) {
                ...
                var proandcity = that.pro + "-" + that.city;
                if (that.elType) {
                    that.el.text(proandcity);
                    PERSONINFO_SECOND.setCity(proandcity);
                } else {
                    that.el.html(proandcity);
                    PERSONINFO_SECOND.setCity(proandcity);
                }

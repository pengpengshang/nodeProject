...
Action.prototype.addErrorCount = function() {
    if (this.errorCount) {
        var count = this.agent.metrics.getMetric('Errors/Count/' + this.name.replace(/\//g, "%2F"));
        count.incrementCallCount(this.errorCount);
        this.errorCount = 0;
    }
};
